...
// Only start a standalone listener outside serverless environments (local dev).
// On Vercel, this module is imported by api/index.js and invoked per-request instead.
